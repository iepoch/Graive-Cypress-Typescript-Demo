            ...
            items: {
                ...
                properties: {
                    ...
                    date_added: {
                        ...
                        examples: ['2008-04-30 10:51:40'],
                    },
                    date_last_updated: {
                        type: 'string',
                        default: '',
                        title: 'The date_last_updated Schema',
                        examples: ['2021-12-24 15:03:00'],
                    },
                    deck: {
                        type: ['null', 'string'],
                        default: '',
                    ...
                    first_appeared_in_game: {
                        ...
                        required: ['api_detail_url', 'id', 'name'],
                        properties: {
                            api_detail_url: {
                                type: ['null', 'string'],
                                default: '',
                    ...
                    image_tags: {
                        ...
                        items: {
                            type: 'object',
                            title: 'A Schema',
                            required: ['api_detail_url', 'name', 'total'],
                            properties: {
                                api_detail_url: {
                                    type: 'string',
                                    title: 'The api_detail_url Schema',
